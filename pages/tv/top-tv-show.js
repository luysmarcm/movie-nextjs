...
const TopTvShow = () => {
	...
	// run effect to load topShow when the page or the searchTerm changes
	useEffect(() => {
		const endpoint =
			searchTerm === ""
				? `${API_URL}tv/top_rated?api_key=${API_KEY}&language=en-US&page=${currentPage}`
  ...
  return (
		<Layout>
			<SeoComponent
				title="moviesNext.js | Top Tv Show"
				description=""
